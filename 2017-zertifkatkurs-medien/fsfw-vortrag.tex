...
\begin{frame}
  ...
  % Noch links zu FSF, FSFE, OSI und so

  % Verweis auf https://www.gnu.org/philosophy/free-sw.en.html?
...
\begin{frame}
  ...
  \begin{center}
    % letzte Folien von Datenspuren-Vortrag übernehmen, wo immer er auch ist …
  \end{center}
