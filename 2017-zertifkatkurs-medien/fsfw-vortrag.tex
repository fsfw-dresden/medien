...
\begin{frame}
  ...
  \begin{center}
  \parbox{7.3cm}{
  {\color{gray!20}     \url{https://fsfw-dresden.de/}}\texttt{\href{https://fsfw-dresden.de/fork}{fork}}\\[1mm]
  {\color{gray!40}     \url{https://fsfw-dresden.de/}}\texttt{\href{https://fsfw-dresden.de/mitmachen}{mitmachen}}\\[1mm]
  {\color{gray!60}     \url{https://fsfw-dresden.de/}}\texttt{\href{https://fsfw-dresden.de/newsletter}{newsletter}}\\[1mm]
  {\color{gray!80}     \url{https://fsfw-dresden.de/}}\texttt{\href{https://fsfw-dresden.de/sprechstunde}{sprechstunde}}\\[3mm]
}\\[3mm]
