...
{\includegraphics[height=1cm]{pdf-gen/tux.pdf}\hspace{0.5cm}\includegraphics[height=1cm]{pdf-gen/fsfw-logo.pdf}\hspace{0.5cm}\includegraphics[height=1cm]{pdf-gen/c3d2-logo.pdf}\\[0.1cm]
\includegraphics[height=1cm]{pdf-gen/stura-logo.pdf}}\hspace{0.5cm}\includegraphics[height=1cm]{pdf-gen/dkn_logo.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}[T]{0.45\textwidth}
      \includegraphics[width=0.9\textwidth]{pdf-gen/fsfw-logo-with-text.pdf}
    \end{column}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}[T]{0.45\textwidth}
      \includegraphics[width=0.9\textwidth]{pdf-gen/tux.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}
      \begin{itemize}
...
\begin{frame}
  ...
  \includegraphics[width=0.95\textwidth]{pdf-gen/dkn_logo.pdf}
  \vspace*{-1em}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.5\textwidth]{pdf-gen/stura-logo.pdf}
  \end{center}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.44\textwidth}
      ...
      \item inzwischen: viele Entwickler von Firmen die Linux
        verwenden
      \end{itemize}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \item abstimmen der Komponenten
...
\begin{frame}
  ...
  \noteitem{Textdateien als Konfigurationsdateien ftw}
  \begin{itemize}
...
\begin{frame}
  ...
  \noteitem{wenige Desktops => Angriffe sind nicht lukrativ}
  \noteitem{viele Server => Sicherheit wird in der Entwicklung berücksichtigt}
  \noteitem{Ob man dann auch ein Update bekomment hängt von der Distribution ab}
...
\begin{frame}
  ...
  \noteitem{Abhängigkeiten, Deduplizierung}
  \noteitem{Programme sind direkt Verfügbar – ohne zwielichtige Downloadseiten}
  \noteitem{Heruntergeladene Pakete werden Verifiziert}
  \begin{columns}
    \begin{column}[T]{0.45\textwidth}
...
\begin{frame}
  ...
  \noteitem{natürlich muss man sich umgewöhnen}
  \begin{itemize}
...
\begin{frame}
  \frametitle{Konsole}
  \noteitem{it's a feature, not a bug}
  \noteitem{Wie bei Mate: Man gewöhnt sich dran …}
  \begin{columns}
    \begin{column}[c]{0.45\textwidth}
      \includegraphics[width=\textwidth]{img-src/terminal.png}
    \end{column}
    \begin{column}[b]{0.45\textwidth}
      \begin{itemize}
  ...
  \begin{columns}
    ...
    \begin{column}{0.45\textwidth}
      \begin{definition}{Dual-Boot}
        bedeutet zwei (oder mehr) Betriebssysteme auf einem Rechner
        installiert zu haben. Beim Einschalten wählt man, welches
...
\begin{frame}
  ...
  \begin{block}{Weiteres Programm}
    \begin{description}
    \item[jetzt] Pause (Getränke und Gebäck)
  ...
  \begin{block}{Außerdem}
    ...
    \item Infomaterial der beteiligten Initiativen
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}
  \frametitle{Nachfolgeveranstaltungen}
  \begin{itemize}
  \item Einsteigerhilfe in der LUG
    \begin{itemize}
    \item mehr unter \url{http://lug-dd.schlittermann.de/}
    \item nächster Termin: 11.05.2016
    \item Ort: Studentenclub GAG18 (Fritz-Löffler-Straße 16)
    \end{itemize}
    % auf die FSFW als anlaufpunkt verweisen, auf die Datenpraxis
    % verweisen?
  \end{itemize}
\end{frame}

% \begin{frame}
%   \frametitle{Andere Veranstaltungen}
%   \begin{itemize}
%   \item FOO
%   \end{itemize}
% \end{frame}
